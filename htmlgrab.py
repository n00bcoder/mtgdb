...
section_lookup = ['_nameRow"', '_manaRow"', '_cmcRow"', '_typeRow"', '_setRow"', '_numberRow"']
...
def parse_the_info(block):
	...
	card_number = get_info_after_value(block, section_lookup[5])
...
def get_card_info(card_id_start, card_id_end):		#M14 set is 370577 - 370825
	...
	cur = cnx.cursor()
	statement = """INSERT INTO cards (id, name, castingCost, type, subtype, text, cardset, rarity, pt, card_number) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"""
